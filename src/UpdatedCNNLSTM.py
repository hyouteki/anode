...
from tensorflow.keras.models import Sequential
from tensorflow.keras.layers import Conv3D, MaxPooling3D, Flatten, LSTM, Dense, Reshape

from tensorflow.keras.models import Sequential
from tensorflow.keras.layers import Conv3D, MaxPooling3D, Flatten, LSTM, Dense, Reshape, Permute

def createModelArchitecture(trainClasses):
    """
    Creates a modified LRCN model using Conv3D without TimeDistributed.
    
    PARAMETERS
    ----------
    - trainClasses : number of output classes for Dense layer
